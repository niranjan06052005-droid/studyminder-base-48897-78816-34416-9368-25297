...
import { ArrowLeft, Play, Pause, Volume2, VolumeX, Maximize, SkipBack, SkipForward, Settings, CheckCircle, Clock, BookOpen, Video } from "lucide-react";
...
const videosData: Record<string, {
  ...
  "v3": {
    id: "v3",
    title: "Module 1.3: Word Problems",
    duration: "18:20",
    chapter: "Chapter 1: Linear Equations in Two Variables",
    subject: "Mathematics",
    description: "Master the art of converting word problems into linear equations. We'll solve various real-world problems step by step.",
    instructor: "Prof. Sharma",
              ...
              <CardContent className="space-y-3">
                {Object.values(videosData)
                  ...
                  .map((relatedVideo) => (
                    <Link 
                      key={relatedVideo.id} 
                      to={`/student/subject/${subject}/video/${relatedVideo.id}`}
                    >
                        ...
                        <CardContent className="p-3">
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {relatedVideo.progress > 0 && relatedVideo.progress < 100 && (
                                <Progress value={relatedVideo.progress} className="h-1 mt-2" />
                              )}
                            </div>
                          </div>
                        </CardContent>
              ...
              <CardContent className="space-y-3">
                {Object.values(videosData)
                  ...
                  .map((otherVideo) => (
                    <Link 
                      key={otherVideo.id} 
                      to={`/student/subject/${subject}/video/${otherVideo.id}`}
                    >
