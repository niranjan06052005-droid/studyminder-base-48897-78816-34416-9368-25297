...
import { ArrowLeft, FileText, Download, BookOpen, ZoomIn, ZoomOut, RotateCw, ChevronLeft, ChevronRight, Edit, Trash2, Eye } from "lucide-react";
...
const pageContents: Record<string, string[][]> = {
  ...
  "n2": [
    [
      ...
      "",
      "1. The sum of two numbers is 15. If twice the first number is added to thrice the second, the sum is 35.",
      "",
  ...
  "n3": [
    ...
    [
      "Example Problems:",
      "",
      "1. Find the nature of roots: x² - 5x + 6 = 0",
      "   D = 25 - 24 = 1 > 0",
      "   Two distinct real roots",
      "",
      "2. Find the nature of roots: x² - 4x + 4 = 0",
      "   D = 16 - 16 = 0",
...
const notesData: Record<string, {
  ...
  "n3": {
    id: "n3",
    title: "Practice Set 2.1 Solutions",
    file: "ch2-ps1.pdf",
...
export default function TeacherChapterNotes() {
          ...
          <div className="mt-8">
            ...
            <div className="grid gap-3">
              {Object.values(notesData)
                ...
                .map((relatedNote) => (
                  <Link key={relatedNote.id} to={`/teacher/class/${classId}/notes/${relatedNote.id}`}>
                      ...
                      <CardContent className="flex items-center justify-between p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">{relatedNote.views} views • {relatedNote.pages} pages</p>
                          </div>
                        </div>
