...
import { StudentStandardProvider } from "./hooks/useStudentStandard";
...
import TeacherVideoEdit from "./pages/TeacherVideoEdit";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/teacher/class/:classId/video/:videoId/edit" element={<TeacherVideoEdit />} />
